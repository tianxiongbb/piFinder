...
from pifinder_basic import fun_read_bed
from pifinder_basic import fun_read_chrom_size
...
def main():
	...
	PATH_BED=sys.argv[1]
	#process
	LIST_BED=fun_read_bed(PATH_BED)
	WINDOW_5P=0
	WINDOW_3P=0
	if len(sys.argv)>3:
